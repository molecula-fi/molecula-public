/**
 * Link to original contract https://github.com/Layr-Labs/eigenlayer-contracts/blob/main/src/contracts/interfaces/IDelegationManager.sol
 */
 ...
 */
interface IDelegationManager is ISignatureUtilsMixin, IDelegationManagerTypes {
