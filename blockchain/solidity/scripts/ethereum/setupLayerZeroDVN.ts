// "setup:dvn:production": "dotenv  -e .env.production hardhat run scripts/ethereum/setupLayerZeroDVN.ts --network sepolia",
// "setup:dvn:test": "                                 hardhat run scripts/ethereum/setupLayerZeroDVN.ts --network sepolia",
